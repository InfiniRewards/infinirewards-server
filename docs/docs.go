    ...
    "paths": {
        ...
        "/merchant/collectible/upgrade": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Upgrade Collectible Contract Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpgradeCollectibleContractRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.UpgradeCollectibleContractResponse"
                        }
                    },
                    "400": {
        ...
        "/merchant/points/upgrade": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Upgrade Points Contract Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpgradePointsContractRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.UpgradePointsContractResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/merchant/upgrade": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Upgrade Merchant Contract Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpgradeMerchantContractRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.UpgradeMerchantContractResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/user/upgrade": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Upgrade User Contract Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpgradeUserContractRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.UpgradeUserContractResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "models.CollectibleContractInfo": {
            ...
            "properties": {
                ...
                "tokenSupplies": {
                    "description": "TokenSupplies lists supplies for each token\nexample: [100,200,300]",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "models.GetCollectibleDetailsResponse": {
            ...
            "properties": {
                "address": {
                    "description": "Address of the collectible collection\nexample: 0x1234567890abcdef1234567890abcdef12345678",
                    "type": "string"
                },
                "description": {
                ...
                "tokenBalances": {
                    "description": "TokenBalances lists balances for each token\nexample: [\"10\",\"20\",\"30\"]",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "models.GetPointsBalanceResponse": {
            ...
            "properties": {
                ...
                "decimals": {
                    "description": "Decimals of the points token\nexample: 18",
                    "type": "integer"
                },
                "description": {
        ...
        "models.UpgradeCollectibleContractRequest": {
            ...
            "properties": {
                "collectibleAddress": {
                    "description": "CollectibleAddress is the address of the collectible contract to upgrade\nexample: 0x1234567890abcdef1234567890abcdef12345678",
                    "type": "string"
                },
                "newClassHash": {
                    "description": "NewClassHash is the class hash of the new implementation contract\nexample: 0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890",
                    "type": "string"
                }
            }
        },
        "models.UpgradeCollectibleContractResponse": {
            ...
            "properties": {
                "transactionHash": {
                    "description": "TransactionHash is the hash of the upgrade transaction\nexample: 0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890",
                    "type": "string"
                }
            }
        },
        ...
        "models.UpgradePointsContractRequest": {
            ...
            "properties": {
                ...
                "pointsContract": {
                    "description": "PointsContract is the address of the points contract to upgrade\nexample: 0x1234567890abcdef1234567890abcdef12345678",
                    "type": "string"
                }
            }
        },
        ...
        "models.User": {
            ...
            "properties": {
                "accountAddress": {
                    "description": "AccountAddress is the user's StarkNet account address",
                    "type": "string"
                },
                "avatar": {
                    "description": "Avatar is the user's avatar",
                ...
                "privateKey": {
                    "description": "PrivateKey is the user's StarkNet private key",
                    "type": "string"
                },
                "publicKey": {
                    "description": "PublicKey is the user's StarkNet public key",
                    "type": "string"
                },
                "updatedAt": {
