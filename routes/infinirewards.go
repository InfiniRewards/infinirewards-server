...
func SetInfiniRewardsRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /merchants/points-contracts", middleware.AuthMiddleware(controllers.GetPointsContractsHandler))
	...
	mux.HandleFunc("GET /merchants/collectible-contracts", middleware.AuthMiddleware(controllers.GetCollectibleContractsHandler))
	...
	mux.HandleFunc("POST /merchants", controllers.CreateMerchantHandler)
